...
# plot multiclass Receiver Operating Characteristic Curve

# there are 3 possible y values
...
# if y_i = 2 for a sample in y, then the third column in y_onehot is assigned
# a 1 and all the others get a 0
